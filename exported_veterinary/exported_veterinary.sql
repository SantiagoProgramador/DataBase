...
CREATE TABLE `historias_clinicas` (
  ...
  `mascotas_mas_id` int(11) NOT NULL,
  PRIMARY KEY (`his_id`),
  KEY `fk_mascotas_mas_id` (`mascotas_mas_id`),
  KEY `fk_historias_clinicas_citas1_idx` (`citas_cit_id`),
  CONSTRAINT `fk_mascotas_mas_id` FOREIGN KEY (`mascotas_mas_id`) REFERENCES `mascotas` (`mas_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `historias_clinicas` VALUES (1,'2024-01-01','Revisión general y vacunación',0,100,3),(2,'2024-01-15','Tratamiento para otitis',0,80,3),(3,'2024-02-01','Cirugía menor - extracción de cuerpo extraño',0,200,3),(4,'2024-02-15','Consulta dermatológica',0,90,3),(5,'2024-03-01','Limpieza dental',0,75,3),(6,'2024-03-15','Vacunación antirrábica',0,50,4),(7,'2024-04-01','Control de parásitos internos y externos',0,60,4),(8,'2024-04-15','Revisión ortopédica',0,110,4),(9,'2024-05-01','Evaluación cardiológica',0,150,4),(10,'2024-05-15','Tratamiento de enfermedades crónicas',0,130,4);
...
INSERT INTO `mascotas` VALUES (3,'Firulais',3,1,1,1,'firulais.jpg'),(4,'Michi',2,0,2,2,'michi.jpg');
...
-- Dump completed on 2024-03-02 10:58:56
